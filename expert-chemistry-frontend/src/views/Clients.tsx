    ...
    <div className="space-y-10">
      <div className="flex justify-between items-end">
        <div>
          ...
          <h1 className="text-4xl font-display font-bold text-white tracking-tight">Partner Registry</h1>
      ...
      <div className="space-y-6">
        {clients.map((client) => (
          <div key={client.id} className="glass-panel group hover:border-primary/30 transition-all cursor-pointer overflow-hidden flex flex-col md:flex-row relative border-white/[0.03] rounded-2xl">
            ...
            <div className="p-8 flex-1 grid grid-cols-1 md:grid-cols-4 gap-10">
              ...
              <div className="md:col-span-1 flex items-center justify-end px-4">

    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-4xl font-display font-bold text-white tracking-tight">Laboratory Assets</h1>
      ...
      <div className="flex gap-4 p-5 glass-panel items-center border-white/[0.03]">
        ...
        />
        <button className="flex items-center gap-2 px-6 py-2.5 hover:bg-white/5 rounded-xl text-white/40 text-[10px] font-mono uppercase tracking-widest border border-white/5 transition-all hover:text-white">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/[0.03] bg-white/[0.01]">
                <th className="px-8 py-6 text-[10px] font-mono text-white/20 uppercase tracking-[0.3em] font-bold">Serial_ID</th>
                <th className="px-8 py-6 text-[10px] font-mono text-white/20 uppercase tracking-[0.3em] font-bold">Asset Nomenclature</th>
                <th className="px-8 py-6 text-[10px] font-mono text-white/20 uppercase tracking-[0.3em] font-bold">Operational Status</th>
                <th className="px-8 py-6 text-[10px] font-mono text-white/20 uppercase tracking-[0.3em] font-bold">Load Factor</th>
                <th className="px-8 py-6 text-[10px] font-mono text-white/20 uppercase tracking-[0.3em] font-bold">Calibration_T</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/[0.03]">
              {equipment.map((item) => (
                <tr key={item.id} className="hover:bg-white/[0.02] transition-colors group cursor-pointer relative">
                  <td className="px-8 py-6 text-sm font-mono text-primary font-bold group-hover:glow-text">{item.id}</td>
                  ...
                  <td className="px-8 py-6 text-xs text-white/40 font-mono tracking-tighter">{item.lastCalibration}</td>
                </tr>
              ))}
            </tbody>
          </table>
